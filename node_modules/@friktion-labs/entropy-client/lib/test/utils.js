...
exports.EntropyProgramId = new web3_js_1.PublicKey('5fP7Z7a87ZEVsKr2tQPApdtq83GcTW4kz919R6ou5h5E');
...
function createDevnetConnection() {
    return new web3_js_1.Connection('https://api.devnet.solana.com', 'confirmed');
}
...
function addSpotMarketToEntropyGroup(client, payer, entropyGroup, mint, spotMarketPk, marketIndex, initialPrice) {
    return __awaiter(this, void 0, void 0, function* () {
        const oraclePk = yield createOracle(client.connection, exports.EntropyProgramId, payer);
        yield client.addOracle(entropyGroup, oraclePk, payer);
        yield client.setOracle(entropyGroup, oraclePk, payer, src_1.I80F48.fromNumber(initialPrice));
        const initLeverage = 5;
        const maintLeverage = initLeverage * 2;
        const liquidationFee = 1 / (2 * maintLeverage);
        yield client.addSpotMarket(entropyGroup, oraclePk, spotMarketPk, mint.publicKey, payer, maintLeverage, initLeverage, liquidationFee, exports.OPTIMAL_UTIL, exports.OPTIMAL_RATE, exports.MAX_RATE);
    });
}
exports.addSpotMarketToEntropyGroup = addSpotMarketToEntropyGroup;
function addSpotMarketsToEntropyGroup(client, payer, entropyGroupPk, mints, spotMarketPks) {
    return __awaiter(this, void 0, void 0, function* () {
        let entropyGroup = yield client.getEntropyGroup(entropyGroupPk);
        for (let i = 0; i < mints.length - 1; i++) {
            const mint = mints[i];
            const spotMarketPk = spotMarketPks[i];
            yield addSpotMarketToEntropyGroup(client, payer, entropyGroup, mint, spotMarketPk, i, 40000);
        }
        return yield client.getEntropyGroup(entropyGroupPk);
    });
}
exports.addSpotMarketsToEntropyGroup = addSpotMarketsToEntropyGroup;
function getNodeBank(client, entropyGroup, bankIndex) {
    return __awaiter(this, void 0, void 0, function* () {
        let rootBanks = yield entropyGroup.loadRootBanks(client.connection);
...
function cachePrices(client, payer, entropyGroup, oracleIndices) {
    return __awaiter(this, void 0, void 0, function* () {
        const pricesToCache = [];
        for (let oracleIndex of oracleIndices) {
            pricesToCache.push(entropyGroup.oracles[oracleIndex]);
        }
        yield client.cachePrices(entropyGroup.publicKey, entropyGroup.entropyCache, pricesToCache, payer);
    });
}
exports.cachePrices = cachePrices;
function cacheRootBanks(client, payer, entropyGroup, rootBankIndices) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield client.cacheRootBanks(entropyGroup.publicKey, entropyGroup.entropyCache, rootBanksToCache, payer);
    });
}
exports.cacheRootBanks = cacheRootBanks;
function performDeposit(client, payer, entropyGroup, entropyAccount, nodeBank, //Todo: Can make explicit NodeBank maybe
tokenAccountPk, tokenIndex, quantity) {
    return __awaiter(this, void 0, void 0, function* () {
        yield client.deposit(entropyGroup, entropyAccount, payer, entropyGroup.tokens[tokenIndex].rootBank, nodeBank.publicKey, nodeBank.vault, tokenAccountPk, quantity);
        return yield client.getEntropyAccount(entropyAccount.publicKey, entropyGroup.dexProgramId);
    });
}
exports.performDeposit = performDeposit;
function getMarket(client, entropyGroup, marketIndex) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield serum_1.Market.load(client.connection, entropyGroup.spotMarkets[marketIndex].spotMarket, {}, entropyGroup.dexProgramId);
    });
}
exports.getMarket = getMarket;
function placeSpotOrder(client, payer, entropyGroup, entropyAccount, market) {
    return __awaiter(this, void 0, void 0, function* () {
        yield client.placeSpotOrder(entropyGroup, entropyAccount, entropyGroup.entropyCache, market, payer, 'buy', 10000, 1, 'limit');
        return yield client.getEntropyAccount(entropyAccount.publicKey, entropyGroup.dexProgramId);
    });
}
