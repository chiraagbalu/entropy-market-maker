...
exports.findPerpMarketParams = exports.calculateLotSizes = exports.throwUndefined = exports.getMultipleAccounts = exports.clamp = exports.getFilteredProgramAccounts = exports.createSignerKeyAndNonce = exports.createTokenAccountInstructions = exports.createAccountInstruction = exports.simulateTransaction = exports.sleep = exports.awaitTransactionSignatureConfirmation = exports.splitOpenOrders = exports.getWeights = exports.EntropyError = exports.TimeoutError = exports.nativeI80F48ToUi = exports.nativeToUi = exports.uiToNative = exports.promiseUndef = exports.zeroKey = exports.ONE_BN = exports.ZERO_BN = void 0;
 ...
 */
function getWeights(entropyGroup, marketIndex, healthType) {
    if (healthType === 'Maint') {
        return {
...
function simulateTransaction(connection, transaction, commitment) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = { encoding: 'base64', commitment: commitment, replaceRecentBlockhash: true };
