...
function initGroup(connection, payer, cluster, groupName, entropyProgramId, serumProgramId, quoteSymbol, quoteMint, feesVault, validInterval, quoteOptimalUtil, quoteOptimalRate, quoteMaxRate) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const groupKey = yield client.initEntropyGroup(quoteMint, config_1.msrmMints[cluster], serumProgramId, feesVault, validInterval, quoteOptimalUtil, quoteOptimalRate, quoteMaxRate, payer);
        const group = yield client.getEntropyGroup(groupKey);
