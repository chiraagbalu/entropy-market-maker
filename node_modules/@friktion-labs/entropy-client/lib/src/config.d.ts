...
export declare const entropyMints: {
    devnet: PublicKey;
    mainnet: PublicKey;
};
...
export declare function getPerpMarketByName(group: GroupConfig, name: string): PerpMarketConfig | undefined;
...
export declare class KeeperConfig {
    cluster_urls: Record<Cluster, string>;
    groups: GroupConfig[];
    constructor(json: any);
}
