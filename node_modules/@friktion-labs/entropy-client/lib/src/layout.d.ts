 ...
 */
/** @internal */
declare class EntropyInstructionsUnion extends Union {
...
export declare const EntropyInstructionLayout: EntropyInstructionsUnion;
/** @internal */
export declare function encodeEntropyInstruction(data: any): Buffer;
/** @internal */
...
/** @internal */
export declare const EntropyGroupLayout: any;
/** @internal */
export declare const EntropyAccountLayout: any;
/** @internal */
...
/** @internal */
export declare const EntropyCacheLayout: any;
export declare class EntropyCache {
    publicKey: PublicKey;
