...
class Fetcher {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const perpMarket = yield entropyGroup.loadPerpMarket(connection, mk.marketIndex, mk.baseDecimals, mk.quoteDecimals);
            let lastSeqNum = _1.ZERO_BN;
            ...
            while (true) {
                ...
                lastSeqNum = queue.seqNum.sub(_1.ONE_BN);
            }
        });
    }
}
