...
class RootBank {
    ...
    getUiTotalDeposit(entropyGroup) {
        const tokenIndex = entropyGroup.getRootBankIndex(this.publicKey);
        return (0, utils_1.nativeI80F48ToUi)(this.getNativeTotalDeposit(), entropyGroup.tokens[tokenIndex].decimals);
    }
    getUiTotalBorrow(entropyGroup) {
        const tokenIndex = entropyGroup.getRootBankIndex(this.publicKey);
        return (0, utils_1.nativeI80F48ToUi)(this.getNativeTotalBorrow(), entropyGroup.tokens[tokenIndex].decimals);
    }
    getBorrowRate(entropyGroup) {
