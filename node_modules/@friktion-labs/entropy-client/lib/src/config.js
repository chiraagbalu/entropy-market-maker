...
exports.KeeperConfig = exports.Config = exports.getTokenBySymbol = exports.getTokenByMint = exports.getMarketByPublicKey = exports.getMarketByBaseSymbolAndKind = exports.getAllMarkets = exports.getSpotMarketByBaseSymbol = exports.getPerpMarketByIndex = exports.getPerpMarketByName = exports.getPerpMarketByBaseSymbol = exports.getOracleBySymbol = exports.getMarketIndexBySymbol = exports.entropyMints = exports.msrmMints = void 0;
const web3_js_1 = require("@solana/web3.js");
const ids_json_1 = __importDefault(require("./ids.json"));
const utils_1 = require("./utils");
exports.msrmMints = {
    devnet: utils_1.zeroKey,
    mainnet: utils_1.zeroKey,
    localnet: utils_1.zeroKey,
    testnet: utils_1.zeroKey,
};
exports.entropyMints = {
...
function getPerpMarketByName(group, name) {
    return group.perpMarkets.find((p) => p.name === name);
}
exports.getPerpMarketByName = getPerpMarketByName;
...
exports.KeeperConfig = KeeperConfig;
