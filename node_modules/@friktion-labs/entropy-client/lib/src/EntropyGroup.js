...
class EntropyGroup {
    ...
    getPrice(tokenIndex, entropyCache) {
        var _a;
        if (tokenIndex === layout_1.QUOTE_INDEX)
            return fixednum_1.ONE_I80F48;
        const decimalAdj = new big_js_1.Big(10).pow(this.getTokenDecimals(tokenIndex) - this.getTokenDecimals(layout_1.QUOTE_INDEX));
        return fixednum_1.I80F48.fromBig((_a = entropyCache.priceCache[tokenIndex]) === null || _a === void 0 ? void 0 : _a.price.toBig().mul(decimalAdj));
    }
    getPriceUi(tokenIndex, entropyCache) {
        var _a;
        if (tokenIndex === layout_1.QUOTE_INDEX)
            return 1;
        return (((_a = entropyCache.priceCache[tokenIndex]) === null || _a === void 0 ? void 0 : _a.price.toNumber()) *
            Math.pow(10, 6 //this.getTokenDecimals(tokenIndex) - this.getTokenDecimals(QUOTE_INDEX),
            ));
    }
    getPriceNative(tokenIndex, entropyCache) {
        if (tokenIndex === layout_1.QUOTE_INDEX)
            return fixednum_1.ONE_I80F48;
    ...
    loadCache(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield connection.getAccountInfo(this.entropyCache);
            if (!account || !(account === null || account === void 0 ? void 0 : account.data))
                throw new Error('Unable to load cache');
            const decoded = layout_1.EntropyCacheLayout.decode(account.data);
            return new layout_1.EntropyCache(this.entropyCache, decoded);
        });
    }
...
exports.default = EntropyGroup;
//# sourceMappingURL=EntropyGroup.js.map