...
exports.krakenBookTickerMapper = exports.krakenBookChangeMapper = exports.krakenTradesMapper = void 0;
...
exports.krakenBookTickerMapper = {
    canHandle(message) {
        if (!Array.isArray(message)) {
            return false;
        }
    ...
    *map(message, localTimestamp) {
        ...
        const ticker = {
            ...
            symbol: message[3],
            exchange: 'kraken',
            askAmount: (0, handy_1.asNumberIfValid)(askVolume),
            askPrice: (0, handy_1.asNumberIfValid)(ask),
            bidPrice: (0, handy_1.asNumberIfValid)(bid),
            bidAmount: (0, handy_1.asNumberIfValid)(bidVolume),
            timestamp,
            localTimestamp: localTimestamp
        };
        yield ticker;
