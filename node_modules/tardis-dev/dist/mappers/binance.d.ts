...
export declare class BinanceBookTickerMapper implements Mapper<'binance-futures' | 'binance-delivery' | 'binance', BookTicker> {
    private readonly _exchange;
    constructor(_exchange: Exchange);
    canHandle(message: BinanceResponse<any>): boolean;
    getFilters(symbols?: string[]): {
    ...
    map(binanceBookTickerResponse: BinanceResponse<BinanceBookTickerData>, localTimestamp: Date): Generator<BookTicker, void, unknown>;
}
...
declare type BinanceBookTickerData = {
    u: number;
    s: string;
    b: string;
    B: string;
