...
const tradesMappers = {
    ...
    okex: (localTimestamp) => shouldUseOkexV5Mappers(localTimestamp) ? new okex_1.OkexV5TradesMapper('okex') : new okex_1.OkexTradesMapper('okex', 'spot'),
    'okex-futures': (localTimestamp) => shouldUseOkexV5Mappers(localTimestamp) ? new okex_1.OkexV5TradesMapper('okex-futures') : new okex_1.OkexTradesMapper('okex-futures', 'futures'),
    'okex-swap': (localTimestamp) => shouldUseOkexV5Mappers(localTimestamp) ? new okex_1.OkexV5TradesMapper('okex-swap') : new okex_1.OkexTradesMapper('okex-swap', 'swap'),
    'okex-options': (localTimestamp) => shouldUseOkexV5Mappers(localTimestamp) ? new okex_1.OkexV5TradesMapper('okex-options') : new okex_1.OkexTradesMapper('okex-options', 'option'),
