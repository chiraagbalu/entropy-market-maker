...
exports.BinanceBookTickerMapper = exports.BinanceLiquidationsMapper = exports.BinanceFuturesDerivativeTickerMapper = exports.BinanceFuturesBookChangeMapper = exports.BinanceBookChangeMapper = exports.BinanceTradesMapper = void 0;
...
class BinanceTradesMapper {
    ...
    getFilters(symbols) {
        symbols = (0, handy_1.lowerCaseSymbols)(symbols);
        return [
            {
                channel: 'trade',
                symbols
...
class BinanceBookTickerMapper {
    ...
    *map(binanceBookTickerResponse, localTimestamp) {
...
exports.BinanceBookTickerMapper = BinanceBookTickerMapper;
