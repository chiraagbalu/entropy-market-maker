...
exports.httpClient = exports.lowerCaseSymbols = exports.upperCaseSymbols = exports.asNumberIfValid = exports.decimalPlaces = exports.CappedSet = exports.CircularBuffer = exports.cleanTempFiles = exports.download = exports.httpsProxyAgent = exports.optimizeFilters = exports.parseμs = exports.batch = exports.getFilters = exports.normalizeMessages = exports.take = exports.HttpError = exports.ONE_SEC_IN_MS = exports.sequence = exports.addDays = exports.addMinutes = exports.sha256 = exports.doubleDigit = exports.formatDateToPath = exports.wait = exports.parseAsUTCDate = void 0;
...
function sha256(obj) {
    return (0, crypto_1.createHash)('sha256').update(JSON.stringify(obj)).digest('hex');
}
...
exports.httpsProxyAgent = process.env.HTTP_PROXY !== undefined ? (0, https_proxy_agent_1.default)(process.env.HTTP_PROXY) : undefined;
async function download({ apiKey, downloadPath, url, userAgent }) {
    const httpRequestOptions = {
        agent: exports.httpsProxyAgent !== undefined ? exports.httpsProxyAgent : httpsAgent,
    ...
    while (true) {
        ...
        try {
            ...
            const attemptsDelayMS = Math.min(Math.pow(2, attempts) * exports.ONE_SEC_IN_MS, 120 * exports.ONE_SEC_IN_MS);
            ...
            (0, debug_1.debug)('download file error: %o, next attempt delay: %d, url %s, path: %s', error, nextAttemptDelayMS, url, downloadPath);
...
async function _downloadFile(requestOptions, url, downloadPath) {
    ...
    (0, fs_extra_1.ensureDirSync)(path_1.default.dirname(downloadPath));
    ...
    const fileWriteStream = (0, fs_extra_1.createWriteStream)(tmpFilePath);
    const cleanup = () => {
        try {
    ...
    try {
        ...
        await new Promise((resolve, reject) => {
            const req = https_1.default
                ...
                .on('error', reject)
                .on('timeout', () => {
                (0, debug_1.debug)('download file request timeout, %s', url);
                req.abort();
            });
        });
        ...
        await (0, fs_extra_1.rename)(tmpFilePath, downloadPath);
    }
    finally {
...
if (exports.httpsProxyAgent !== undefined) {
    gotDefaultOptions.agent = {
        https: exports.httpsProxyAgent
    };
}
...
exports.httpClient = got_1.default.extend(gotDefaultOptions);
