...
declare abstract class HuobiRealTimeFeedBase extends MultiConnectionRealTimeFeedBase {
    ...
    protected _getRealTimeFeeds(exchange: string, filters: Filter<string>[], timeoutIntervalMS?: number, onError?: (error: Error) => void): Generator<HuobiMarketDataRealTimeFeed | HuobiNotificationsRealTimeFeed | HuobiOpenInterestClient | HuobiOptionsMarketIndexClient | HuobiOptionsIndexClient, void, unknown>;
    protected getOpenInterestURLPath(symbol: string): string;
}
...
declare class HuobiOptionsMarketIndexClient extends PoolingClientBase {
    private readonly _httpURL;
    private readonly _instruments;
    constructor(exchange: string, _httpURL: string, _instruments: string[]);
    protected poolDataToStream(outputStream: Writable): Promise<void>;
}
declare class HuobiOptionsIndexClient extends PoolingClientBase {
    private readonly _httpURL;
    private readonly _instruments;
    constructor(exchange: string, _httpURL: string, _instruments: string[]);
    protected poolDataToStream(outputStream: Writable): Promise<void>;
...
export declare class HuobiDMOptionsRealTimeFeed extends HuobiRealTimeFeedBase {
    protected wssURL: string;
    protected httpURL: string;
    protected suffixes: {
        trade: string;
