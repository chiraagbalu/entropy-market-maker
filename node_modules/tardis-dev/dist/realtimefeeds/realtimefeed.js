...
class RealTimeFeedBase {
    constructor(_exchange, filters, _timeoutIntervalMS, _onError) {
            ...
            try {
                ...
                for (const message of subscribeMessages) {
                    ...
                    if (this.throttleSubscribeMS > 0) {
                        await (0, handy_1.wait)(this.throttleSubscribeMS);
                    }
                }
                ...
                await (0, handy_1.wait)(1 * handy_1.ONE_SEC_IN_MS);
        ...
        this._filters = (0, handy_1.optimizeFilters)(filters);
        this.debug = (0, debug_1.default)(`tardis-dev:realtime:${_exchange}`);
        this._wsClientOptions = { perMessageDeflate: false, handshakeTimeout: 10 * handy_1.ONE_SEC_IN_MS, skipUTF8Validation: true };
        if (handy_1.httpsProxyAgent !== undefined) {
            this._wsClientOptions.agent = handy_1.httpsProxyAgent;
        }
    }
    ...
    async *_stream() {
        ...
        while (true) {
            try {
                ...
                this._ws = new ws_1.default(finalWssUrl, this._wsClientOptions);
            ...
            (async function writeMessagesToCombinedStream() {
                for await (const message of realTimeFeed) {
                    ...
                    if (!combinedStream.write(message))
                        ...
                        await (0, events_1.once)(combinedStream, 'drain');
                }
            })();
        }
...
class PoolingClientBase {
    constructor(exchange, _poolingIntervalSeconds) {
        ...
        this._tid = undefined;
        this.debug = (0, debug_1.default)(`tardis-dev:pooling-client:${exchange}`);
    }
    [Symbol.asyncIterator]() {
        return this._stream();
    }
