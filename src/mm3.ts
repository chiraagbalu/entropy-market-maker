...
function makeMarketUpdateInstructions(
  ...
  console.log(`${marketContext.marketName}: lift offer below ${(1 - mispriced) * fairValue}`)
  console.log(`${marketContext.marketName}: hit bid above ${(1 + mispriced) * fairValue}`)


  if (bestBid !== undefined && bestBid?.price > (1 + mispriced) * fairValue) {
    console.log('--------------------------------------------------------------------------------------------------')
    console.log(`mispricing: in ${marketContext.marketName}`)
    console.log(`bestBid: ${bestBid?.price} above ${(1 + mispriced) * fairValue}`)
  ...
  } else if (bestAsk !== undefined && bestAsk?.price < (1 - mispriced) * fairValue) {
    console.log('--------------------------------------------------------------------------------------------------')
    console.log(`mispricing: in ${marketContext.marketName}`)
    console.log(`bestAsk: ${bestAsk?.price} below ${(1 - mispriced) * fairValue}`)
